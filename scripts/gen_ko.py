...
build('kyul.html', 'kyul.ko.html', [
    ...
    ('<meta property="og:title" content="Kyul 결 — try it too 🖌️" />',
     '<meta property="og:title" content="결 — 너도 해봐 🖌️" />'),
    ('<meta property="og:description" content="A Korean word puzzle that shapes the world. Link letters, awaken words, paint the scroll." />',
     '<meta property="og:description" content="말로 세상을 빚는 한글 퍼즐. 자모를 이어 단어를 깨우고, 두루마리에 산수화를 그리세요." />'),
    ('<meta property="og:locale" content="en_US" />\n<meta property="og:locale:alternate" content="ko_KR" />',
     '<meta property="og:locale" content="ko_KR" />\n<meta property="og:locale:alternate" content="en_US" />'),
])
